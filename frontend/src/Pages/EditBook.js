...
const EditBook = () => {
    ...
    useEffect(() => {
        const fetchBook = async () => {
            try {
                const { data } = await axios.get(`https://bookstore-i6jo.onrender.com/api/books/${id}`);
                setBookData(data);
            } catch (error) {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            await axios.patch(`https://bookstore-i6jo.onrender.com/api/books/${id}`, bookData, config);
