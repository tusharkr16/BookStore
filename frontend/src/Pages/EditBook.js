...
const EditBook = () => {
    ...
    useEffect(() => {
        const fetchBook = async () => {
            try {
                const { data } = await axios.get(`https://bookstore-9kvi.onrender.com/api/books/${id}`);
                setBookData(data);
            } catch (error) {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            await axios.patch(`https://bookstore-9kvi.onrender.com/api/books/${id}`, bookData, config);
